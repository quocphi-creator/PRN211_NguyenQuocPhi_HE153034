...
namespace DataAccess
{
    public class MemberDAO
    {
        ...
        {
            new Member{MemberID=3, MemberName="Phi", Email="phi@gmail.com", Password="phi", City="Ha Noi",Country="Viet Nam"},
            new Member{MemberID=4, MemberName="Lam", Email="lam@gmail.com", Password="lam", City="Hung Yen",Country="Viet Nam"},
        };
