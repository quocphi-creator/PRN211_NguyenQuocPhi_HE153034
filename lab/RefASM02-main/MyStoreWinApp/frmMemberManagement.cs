...
namespace MyStoreWinApp
{
    ...
    public partial class frmMemberManagement : Form
    {
        ...
        private SearchBy _searchBy = SearchBy.ByEmail;
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var result = _memberRepository.DeleteMemberAsync(m.MemberID).Result;
                if (result == 1)
                {
                    LoadMemberList();
                }
        ...
        private void rdMemberEmail_CheckedChanged(object sender, EventArgs e)
        {
            if (rdMemberID.Checked)
            {
                _searchBy = SearchBy.ByEmail;
            }
        }
